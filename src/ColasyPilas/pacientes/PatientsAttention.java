...
public class PatientsAttention {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i<numOfPatients; i++){
            ...
            String name= attendingPatient.getName();
            String gravity = attendingPatient.getGravity().getDecripcion();
            System.out.println("Atendiendo al paciente: "+name + "con gravedad nivel: "+gravity);
        }
    }
}
